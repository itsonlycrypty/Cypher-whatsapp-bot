...
const { startBot } = require('./bot/index'); // your main bot
...
app.get('/api/pair', async (req, res) => {
  ...
  // If it's a ping request (for latency check)
...
// ========== START THE MAIN BOT ==========
// The bot will run in the background, using persistent auth (auth/ folder)
